  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-b from-dark-900 to-dark-950">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="text-primary-400 font-mono text-sm mb-4 block">
            {t('contact.subtitle')}
          </span>
          <h2 className="text-3xl sm:text-5xl font-bold mb-6 bg-gradient-to-r from-primary-400 to-primary-600 bg-clip-text text-transparent">
            {t('contact.title')}
          </h2>
          ...
          <div className="mt-16 flex justify-center space-x-6">
            {socialLinks.map((link, index) => (
              <motion.a
                ...
                className="p-3 text-gray-400 hover:text-primary-400 transition-colors duration-200 bg-dark-900/50 rounded-lg backdrop-blur-sm border border-dark-800 hover:border-primary-500/50"
